...
public class ViewRoutinePagerAdapter extends PagerAdapter implements CardAdapter {


    private ViewRoutinePagerAdapter.OnItemClickListener mListener;
    ...
    public ViewRoutinePagerAdapter() {
        editingMode = false;
        mData = new ArrayList<>();
    ...
    public static void setEditingMode(boolean editingMode) {
        ViewRoutinePagerAdapter.editingMode = editingMode;
    }
    ...
    public void setOnItemClickListener(ViewRoutinePagerAdapter.OnItemClickListener listener) {
        mListener = listener;
    }
