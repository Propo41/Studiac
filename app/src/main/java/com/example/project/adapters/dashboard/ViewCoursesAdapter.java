...
public class ViewCoursesAdapter extends RecyclerView.Adapter<ViewCoursesAdapter.ViewCoursesViewHolder> {
    ...
    public ViewCoursesAdapter(ArrayList<CourseItems> courseItems) {
    ...
    static class ViewCoursesViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewCoursesViewHolder(View itemView, final OnItemClickListener customListener, int view_type) {
            super(itemView);
            mCourseNameTv = itemView.findViewById(R.id.bulletin_user_name_id);
