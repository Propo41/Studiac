...
public class Day {
    private ArrayList<Object> mTodoTasks; // may contain objects of Course, Others, SelfStudy, Task
    ...
    private String[] months = {"Jan", "Feb", "March", "April", "May", "June", "July", "August", "September", "October",
    "November", "December"};
    ...
    public Pair<Integer, Integer> isVisited(Object object){
        ...
        }else if(className.equals("Others")){
            return mVisited.get("Others");
        }else if(className.equals("Self Study")){
    ...
    private String parseDate(Object object){
        ...
        return months[Integer.parseInt(dateContents[1])-1] + " " + dateContents[2];
    }
