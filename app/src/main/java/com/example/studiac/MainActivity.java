       ...
       //mDialog=new Dialog(this);
        ...
        incorrectCretentialPopupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                        ...
                        dialog.setContentView(R.layout.login_popup_incorrectcredential);
                        ...
                        //dialog (login_popup_incorrectcredential)end
                        */
                        final Dialog dialogAddroutine = new Dialog(context);
                        dialogAddroutine.setContentView(R.layout.setupprofile2_popup_addroutine);
        ...
        setupProfileButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent changeimgIntent = new Intent(MainActivity.this,SetupprofileChangimg.class);
        ...
        courseAddedPopupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogCourseadded.setContentView(R.layout.setupprofile2_popup_courseadded);
        ...
        forgotPasswordPopupbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogForgotpasswordAlert.setContentView(R.layout.forgotpassword_popup_alert);
