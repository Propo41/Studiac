...
public class CalculateGPABottomSheet extends BottomSheetDialogFragment {
    ...
    private void initializeViews(View v) {
        ...
        mCalculateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //  updateValuesList();
                Double gpa = mListener2.calculateSemesterGpa();
                mResult.setGpa(gpa);
    ...
    private void initializeAdapter(View v) {
    ...
    public void onDismiss(@NonNull DialogInterface dialog) {
        ...
        for (int i = 0; i < mResultList.get(mResultList.size() - 1).getGradesObtained().size(); i++) {
            ...
            System.out.println("In Calcu sem bth sheet " + mCourseList.get(i).getCode() + "  " + str);
        }
        //updateValuesList();
        //mResult.setGradesObtainedValue(fixFirstItemBottomSheetCalculateSemesterGPA, fixFirstItemBottomSheetCalculateSemesterGPA2);
        //mResultList.get(mResultList.size()-1).setGradesObtainedValue(fixFirstItemBottomSheetCalculateSemesterGPA,fixFirstItemBottomSheetCalculateSemesterGPA2);
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            mListener2 = (OnItemClickListener) context;
