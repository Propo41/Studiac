...
public class ProfileViewDialog extends AppCompatDialogFragment {
    ...
    public ProfileViewDialog(Student basicInfo, View view) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        if (window != null) {
            ...
            windowManager.gravity = Gravity.TOP | Gravity.START | Gravity.CENTER_HORIZONTAL;

            // the window will pop up from center of image view
           windowManager.x = (int) (mClickedView.getX() + mClickedView.getWidth() / 2);
            windowManager.y = (int) (mClickedView.getY() + mClickedView.getHeight() / 2);
