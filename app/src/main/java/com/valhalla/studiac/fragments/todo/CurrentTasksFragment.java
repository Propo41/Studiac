...
public class CurrentTasksFragment extends Fragment implements AddTaskBottomSheetDialog.BottomSheetListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRoot = mView.findViewById(R.id.current_tasks_root);
        setupList();
    ...
    private void handleEvents() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bottomSheetDialog.show(requireFragmentManager(), "currentTasks");
    ...
    /**
     * removes a task from local memory
     * after removing it, it shows a snack bar to undo any changes
     */
    private void removeTask(final int position) {
        final Task deletedTask = (Task) mCurrentTasks.get(position);
        mCurrentTasks.remove(position);
        mAdapter.notifyItemRemoved(position);

        Snackbar snackbar = Snackbar
                .make(mRoot, "Task deleted.", Snackbar.LENGTH_LONG)
                .setAction("UNDO", new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        mCurrentTasks.add(position, deletedTask);
