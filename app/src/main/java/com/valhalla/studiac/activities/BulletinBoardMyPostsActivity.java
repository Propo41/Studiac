                ...
                addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (basicInfo != null) {
                            ...
                            childUpdates.put("/" + Firebase.UNIVERSITIES + "/" +
                                    basicInfo.getUniversityName() + "/" + Firebase.POSTS + "/" +
                                    mPostsKeys.get(position), null);
                            childUpdates.put("/" + Firebase.USER_POSTS + "/" + mUser.getUid() + "/"
                                    + mPostsKeys.get(position), null);
                            Firebase.getDatabaseReference().updateChildren(childUpdates).addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(BulletinBoardMyPostsActivity.this,
