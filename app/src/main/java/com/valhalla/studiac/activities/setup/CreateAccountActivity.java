...
public class CreateAccountActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        new CountDownTimer(TIMEOUT, 1000) {
            ...
            public void onFinish() {
                if (dialogState) {
                    ...
                    Toast toast = Toast.makeText(CreateAccountActivity.this, "Connection timeout.", Toast.LENGTH_SHORT);
    ...
    private boolean isInputValid() {
        ...
        if (mNameField.length() < 6) {
            errorStyle.setError(getString(R.string.Error_ShortName), mNameField);
            return false;
        } else {
            errorStyle.resetError(mNameField);
        }
