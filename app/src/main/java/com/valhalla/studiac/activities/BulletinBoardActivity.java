...
public class BulletinBoardActivity extends AppCompatActivity implements
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.more_view_posts_id:
                startActivityForResult(new Intent(this, BulletinBoardMyPostsActivity.class), RESULT_DELETED_POSTS);
                return true;
            default:
    ...
    private void refreshContent(SwipeRefreshLayout swipeRefreshLayout) {
        // download all contents again
    ...
    private void handleListEvents() {
        mAdapter.setOnItemClickListener(new BulletinRecycleAdapter.OnItemClickListener() {
            ...
            public void onProfileClick(int position, View view) {
                ProfileViewDialog profileViewDialog = new ProfileViewDialog(mUserInfo, view);
    ...
    private void likePost(int position) {
        ...
        if (isLiked != null) {
            Toast.makeText(this, "You've already shown interest to this post!", Toast.LENGTH_SHORT).show();
        } else {
                                    ...
                                    addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            Toast.makeText(BulletinBoardActivity.this,
                                                    "message uploaded", Toast.LENGTH_SHORT).show();
