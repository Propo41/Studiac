...
public class ViewCoursesActivity extends NavigationToolbarWhite implements AddCourseBottomSheetDialog.BottomSheetListener {
    ...
    private final String TAG = "ViewCoursesActivity";
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        /*    FirebaseDatabase.getInstance().getReference().setValue(mRoutines);
            FirebaseDatabase.getInstance().getReference().setValue(mCourses);
...
/*
            //upload current semester result (course list) to database with updated values
            Firebase.getDatabaseReference().
                    child(Firebase.USERS).
                    child(mUser.getUid()).
                    child(Firebase.RESULTS).
                    child(currentSemester + "").
                    setValue(mCurrentSemesterResult);*/
        }
