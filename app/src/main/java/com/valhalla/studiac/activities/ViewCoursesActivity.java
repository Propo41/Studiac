...
public class ViewCoursesActivity extends NavigationToolbarWhite implements AddCourseBottomSheetDialog.BottomSheetListener {
            ...
            public void onButtonClick(final int position) {
                ...
                dialog.setOnUpdateClickListener(new CourseEditBottomSheetDialog.OnUpdateClickListener() {
                    ...
                    public void onUpdateClick(boolean codeChanged, String oldCode,
                                              boolean nameChanged, String oldCourseName) {
                        ...
                        // if the course name/code is changed, update it in the routine as well
                                ...
                                if (index != null) {
                                    ...
                                    if (schedules != null) {
                                        for (Schedule schedule : schedules) {
                                            ...
                                            if (schedule.getDescription().equals(oldCourseName)) {
                                                schedule.setDescription(mCourses.get(position).getName());
                                            }
                                        }
                                    }
                                }
     ...
     */
    public void onAddCourseClickListener() {

        mAddCourseButton = findViewById(R.id.view_courses_add_course_button_id);
