...
public class ViewCoursesRecycleAdapter extends RecyclerView.Adapter<ViewCoursesRecycleAdapter.ViewCoursesViewHolder> {
    ...
    public ViewCoursesRecycleAdapter(Context context, ArrayList<Course> courseItems) {
    ...
    public ViewCoursesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_viewcourses, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewCoursesViewHolder holder, int position) {
        ...
        if (mCourseItems.size() != 0) {
            ...
            holder.mCourseCreditTv.setText(mContext.getString(R.string.PlaceHolder_CourseCredit, course.getCredit() + ""));
            holder.mCourseCodeTv.setText(mContext.getString(R.string.PlaceHolder_CourseCode, course.getCode()));
            if (course.getType().equals(Common.COURSE_TYPE_2)) {
                holder.mCardView.setCardBackgroundColor(mContext.getResources().getColor(R.color.colorPurple, null));
            }
        }
    ...
    static class ViewCoursesViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewCoursesViewHolder(View itemView, final OnItemClickListener customListener, int view_type) {
            super(itemView);
            mCardView = itemView.findViewById(R.id.view_courses_card_view_id);
            ...
            mCourseCodeTv = itemView.findViewById(R.id.bulletin_post_topic_id);
