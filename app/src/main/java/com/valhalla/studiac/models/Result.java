...
public class Result {
    ...
    private Boolean isGpaCalculated;
    ...
    public Boolean getIsGpaCalculated() {
        return isGpaCalculated;
    }

    public void setIsGpaCalculated(Boolean gpaCalculated) {
        this.isGpaCalculated = gpaCalculated;
    }
